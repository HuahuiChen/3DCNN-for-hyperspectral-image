...
num_total_samples=10000; %to simulate data being read from disk / generated etc.
data_disk=rand(5,5,1,num_total_samples); %matlab arranges the elements from the first dimension to the last while caffe and hdf5 stores the arrays from the last dimension to first.
